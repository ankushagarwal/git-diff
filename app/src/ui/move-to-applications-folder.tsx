...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move GitDiff to the Applications folder?"
      ...
      >
        <DialogContent>
          <p>
            We've detected that you're not running GitDiff from the Applications
            folder of your machine. This could cause problems with the app,
            including impacting your ability to sign in.
          </p>
          <p>
            Do you want to move GitDiff to the Applications folder now? This
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move GitDiff to the Applications folder in your machine and restart the app."
